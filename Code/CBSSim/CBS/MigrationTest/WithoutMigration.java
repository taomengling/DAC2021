...
public class WithoutMigration {
	...
	public static void main(String[] args) throws IOException {
		...
		String inputFolder = "E://cloudsim4/cloudsim-cloudsim-4.0/modules/cloudsim-examples/src/main/resources/workload2020";
		String outputFolder = "output";
		String workload = "Shanghai"; // CBS workload
		String vmAllocationPolicy = "no migration"; // First Fit without CD migrations
