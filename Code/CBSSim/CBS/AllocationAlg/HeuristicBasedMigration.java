...
import org.cloudbus.cloudsim.examples.CBS.HeuristicAlg.Simulate_Annealing;
...
public class HeuristicBasedMigration extends PowerVmAllocationPolicyMigrationAbstract {
    /**
     ...
     */
    public HeuristicBasedMigration(
...
//        PowerVmList.sortByDiskSizeUtilization(vmsToMigrate);
    ...
    getVmsAbleToMigration(List<PowerHostUtilizationHistory> overUtilizedHosts) {
        ...
        HeuristicDiskSelection selection = (HeuristicDiskSelection)getVmSelectionPolicy();
