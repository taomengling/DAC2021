...
public class AMScheduleSystem {
    public static void main(String[] args) throws IOException {
        ...
        String vmAllocationPolicy = "modified_GA"; // heuristic migration strategy
        String vmSelectionPolicy = "disk_group"; // heuristic disk selection strategy
        String balance_parameter = "0.05";
